...
The Diagnosis class represents a medical diagnosis made for a patient, containing information about the diagnosis
ID, patient's fiscal code, date, systolic and diastolic blood pressure readings and symptoms.
Diagnosis objects are constructed with a Diagnosis ID, the patient's fiscal code, the date of the diagnosis,
and the systolic and diastolic blood pressure readings.
The class provides getter methods to retrieve the diagnosis ID, patient's fiscal code, date, systolic and diastolic
blood pressure readings, and symptoms.
The Diagnosis object is associated with a list of symptoms using an ObservableList<Symptom> object.
...
public class Diagnosis {
	...
	Constructs a Diagnosis object with the given ID, patient's fiscal code, date, systolic and diastolic blood pressure readings.
	@param ID the ID of the diagnosis
	@param CF_Patient the patient's fiscal code
	...
	*/
	...
	Returns the patient's fiscal code for the diagnosis.
	@return the patient's fiscal code for the diagnosis
	*/
	...
	Returns the property object for the patient's fiscal code for the diagnosis.
	@return the property object for the patient's fiscal code for the diagnosis
	*/
	...
	*/
	...
	Returns the IntegerProperty object representing the SBP (systolic blood pressure) property of the Diagnosis.
	...
	*/
	...
	Returns the value of the DBP (diastolic blood pressure) property of the Diagnosis.
	...
	*/
	...
	Returns the IntegerProperty object representing the DBP (diastolic blood pressure) property of the Diagnosis.
